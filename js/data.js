...
(function () {
  ...
  D.LEAGUES = [
    ...
    { id: "ger-2bundesliga", name: "2. Bundesliga", country: "Alemania", group: "Alemania", teams: ["Hertha BSC","Schalke 04","Fortuna Düsseldorf","1. FC Nürnberg","Karlsruher SC","Hannover 96","SC Paderborn","SV Darmstadt 98","Holstein Kiel","1. FC Kaiserslautern","Greuther Fürth","SV Elversberg","1. FC Magdeburg","Eintracht Braunschweig","Preußen Münster","Arminia Bielefeld","SpVgg Greuther","Dynamo Dresden"] },
    // —— Francia ——
    ...
    { id: "tur-superlig", name: "Süper Lig", country: "Turquía", group: "Resto de Europa", teams: ["Galatasaray","Fenerbahçe","Beşiktaş","Trabzonspor","Başakşehir","Konyaspor","Antalyaspor","Alanyaspor","Kayserispor","Samsunspor","Çaykur Rizespor","Göztepe","Kasımpaşa","Gaziantep FK","Eyüpspor","Bodrum","Kocaelispor","Gençlerbirliği"] },
    { id: "sco-premiership", name: "Scottish Premiership", country: "Escocia", group: "Resto de Europa", teams: ["Celtic","Rangers","Aberdeen","Heart of Midlothian","Hibernian","Dundee United","Dundee","Motherwell","St Mirren","Kilmarnock","Ross County","St Johnstone","Livingston","Falkirk"] },
    { id: "bel-proleague", name: "Pro League", country: "Bélgica", group: "Resto de Europa", teams: ["Club Brugge","Anderlecht","Royal Antwerp","Genk","Gent","Union Saint-Gilloise","Standard Liège","Cercle Brugge","Charleroi","Mechelen","Westerlo","OH Leuven","Sint-Truiden","Dender","Kortrijk","Beerschot"] },
    { id: "den-superliga", name: "Superliga", country: "Dinamarca", group: "Resto de Europa", teams: ["FC Copenhagen","FC Midtjylland","Brøndby","AGF Aarhus","Nordsjælland","Silkeborg","Viborg","Randers","SønderjyskE","Vejle","Lyngby","Fredericia"] },
    { id: "swe-allsvenskan", name: "Allsvenskan", country: "Suecia", group: "Resto de Europa", teams: ["Malmö FF","AIK","Djurgården","Hammarby","IFK Göteborg","IF Elfsborg","BK Häcken","IFK Norrköping","Kalmar FF","Halmstad","Mjällby","GAIS","IK Sirius","Värnamo","Brommapojkarna","Degerfors"] },
    { id: "nor-eliteserien", name: "Eliteserien", country: "Noruega", group: "Resto de Europa", teams: ["Bodø/Glimt","Molde","Rosenborg","Brann","Viking","Lillestrøm","Vålerenga","Strømsgodset","Sarpsborg 08","Tromsø","Haugesund","Fredrikstad","KFUM Oslo","Kristiansund","Sandefjord","HamKam"] },
    { id: "aut-bundesliga", name: "Bundesliga (Austria)", country: "Austria", group: "Resto de Europa", teams: ["Red Bull Salzburg","Sturm Graz","Rapid Wien","Austria Wien","LASK","Wolfsberger AC","TSV Hartberg","WSG Tirol","Austria Klagenfurt","Blau-Weiß Linz","Grazer AK","SCR Altach"] },
    { id: "sui-superleague", name: "Super League (Suiza)", country: "Suiza", group: "Resto de Europa", teams: ["Young Boys","Basel","Servette","Lugano","FC Zürich","Lausanne-Sport","St. Gallen","Luzern","Sion","Grasshopper","Yverdon-Sport","Winterthur"] },
    ...
    // —— Resto del mundo ——
    { id: "sau-prolegaue", name: "Roshn Saudi League", country: "Arabia Saudí", group: "Resto del mundo", teams: ["Al-Hilal","Al-Nassr","Al-Ittihad","Al-Ahli","Al-Ettifaq","Al-Shabab","Al-Taawoun","Al-Fateh","Al-Khaleej","Al-Fayha","Al-Riyadh","Al-Wehda","Al-Okhdood","Al-Qadsiah","Damac","Al-Raed","Al-Hazem","Neom"] },
    ...
    { id: "arg-ligaprofesional", name: "Liga Profesional", country: "Argentina", group: "Resto del mundo", teams: ["River Plate","Boca Juniors","Racing Club","Independiente","San Lorenzo","Estudiantes","Vélez Sarsfield","Talleres","Argentinos Juniors","Rosario Central","Newell's Old Boys","Lanús","Defensa y Justicia","Huracán","Banfield","Gimnasia La Plata","Belgrano","Instituto","Godoy Cruz","Tigre"] },
    { id: "aus-aleague", name: "A-League Men", country: "Australia", group: "Resto del mundo", teams: ["Melbourne City","Melbourne Victory","Sydney FC","Western Sydney Wanderers","Central Coast Mariners","Adelaide United","Brisbane Roar","Wellington Phoenix","Macarthur FC","Perth Glory","Newcastle Jets","Western United","Auckland FC"] },
